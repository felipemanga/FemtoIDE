...
public:
    ...
    std::uint32_t getFrameX(){ return getFrameBitmap(getFrameId(frame))[0]; }

    std::uint32_t getFrameY(){ return getFrameBitmap(getFrameId(frame))[1]; }
...
extern const BulletSprite bulletSprite;
extern const EnemySprite enemySprite;
extern const Heads heads;
extern const Ships ships;
extern const Start start;
}
